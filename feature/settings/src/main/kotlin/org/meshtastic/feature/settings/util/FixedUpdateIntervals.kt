...
enum class FixedUpdateIntervals(
    ...
    ONE_HOUR(1.hours.inWholeSeconds, pluralRes = Res.plurals.plurals_hours, quantity = 1),
    ...
    EIGHTY_SECONDS(80L.seconds.inWholeSeconds, pluralRes = Res.plurals.plurals_seconds, quantity = 80),
    NINETY_SECONDS(90L.seconds.inWholeSeconds, pluralRes = Res.plurals.plurals_seconds, quantity = 90),
    EIGHT_SECONDS(8L.seconds.inWholeSeconds, pluralRes = Res.plurals.plurals_seconds, quantity = 8),
    FORTY_SECONDS(40L.seconds.inWholeSeconds, pluralRes = Res.plurals.plurals_seconds, quantity = 40),
    ;
