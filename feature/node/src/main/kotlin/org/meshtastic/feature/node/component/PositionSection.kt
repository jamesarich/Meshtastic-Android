...
fun PositionSection(
    ...
    TitledCard(title = stringResource(Res.string.position), modifier = modifier) {
        ...
        ListItem(
            text = stringResource(Res.string.compass),
            leadingIcon = Icons.Default.CompassCalibration,
            trailingIcon = null,
            onClick = {
                // Navigate to CompassScreen with node as the waypoint
                onAction(
                    NodeDetailAction.Navigate(
